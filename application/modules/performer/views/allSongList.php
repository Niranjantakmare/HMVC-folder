...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
		...
		<div class="container" style="display:none">
         <div class="row">
            ...
            <div class="col-12 col-md-12 col-sm-12 tabbingmainsection">
				...
				<img src="<?php echo base_url(); ?>assets/images/plussong.png" class="imgshow" id="" title="">
				<span class="addshowspan">Add to my song list</span>
			</div>
                        </div>
	...
	if(searchString!=""){
			var URL="<?php echo base_url(); ?>index.php/webservices/performers/AllSongsList/"+page+"/10/";
	}else{
		var URL="<?php echo base_url(); ?>index.php/webservices/performers/AllSongsList/"+page+"/10/";
	}
	...
	$(document).ready(function(){
		$( ".table-wrapper-scroll-y" ).scroll(function() {
			...
			if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
					...
					var searchString=$.trim($("#searchStr").val());
					if(searchString!=""){
							var URL="<?php echo base_url(); ?>index.php/webservices/performers/AllSongsList/"+totalItems+"/10";
					}else{
						var URL="<?php echo base_url(); ?>index.php/webservices/performers/AllSongsList/"+totalItems+"/10/";
					}
					loadMoreData(URL,0);
...
$("#searchStr").keyup(function (e){
   ...
   // var user_name = $(this).val();
	...
	$("#searchStr").change(function(){
			...
			if(searchString==""){
				var URL="<?php echo base_url(); ?>index.php/webservices/performers/AllSongsList/"+page+"/10/"+searchString;
				loadMoreData(URL,1);
				page++;
				$("#noOfSong").val(page);
			}
